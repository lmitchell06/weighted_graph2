...
class weighted_graph {
	...
	std::unordered_set<vertex> get_neighbours(const vertex&); //Returns a vector containing the neighbours of the given vertex.
...
template <typename vertex>	std::unordered_set<vertex> weighted_graph<vertex>::get_neighbours(const vertex& u) {
